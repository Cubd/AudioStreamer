...
@interface iPhoneStreamingPlayerViewController() <UITextFieldDelegate>
...
//
// Parameters:
//    imageName - the name of the image to set on the play button.
//
- (void)setButtonImageNamed:(NSString *)imageName
{
	if (!imageName)
...
#pragma mark - AudioStreamer Lifecycle
//
// destroyStreamer
//
